...
public class BWSDamageTypes {
	...
	public static final DamageType FIRE = new DamageType("damagetype.fire", false, true, "betterwithsouls:gui/dmg_fire");
	...
	public static final DamageType POISON = new DamageType("damagetype.poison", false, true, "betterwithsouls:gui/dmg_poison");
	public static final DamageType BLOOD = new DamageType("damagetype.blood", false, true, "betterwithsouls:gui/dmg_blood");
	...
	public static boolean isElemental(DamageType type){
		return type == MAGIC
			|| type == DARK
			|| type == LIGHTNING;
	}
