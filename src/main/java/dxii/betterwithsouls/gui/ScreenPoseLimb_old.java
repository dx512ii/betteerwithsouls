...
public class ScreenPoseLimb_old extends Screen {
	...
	public ScreenPoseLimb_old() {
		this(null);
	}
	public ScreenPoseLimb_old(Screen parent) {
		super(parent);
	}



	public ScreenPoseLimb_old(BipedLimbInfo limb, String name, int xOffset, int yOffset) {
		this(null);
