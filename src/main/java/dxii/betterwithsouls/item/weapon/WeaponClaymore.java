...
//attack3 - parrying
public class WeaponClaymore extends ItemWeaponMelee {
	public WeaponClaymore(WeaponMaterial mat, String name, int id) {
		super(mat, name, id);
	...
	public void attack3(ItemStack itemstack, World world, Player entityplayer, boolean timed){
		this.dinfo1.setDmgType(BWSDamageTypes.THRUST);
		attackDefault(1, 1.25f, 1.25f, -.85f, itemstack, world, entityplayer, timed);
	}
